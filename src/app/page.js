...
export default function Home() {
  ...
  const { data: productData, loading, error } = useFetch(`${process.env.NEXT_PUBLIC_JSON_SERVER_URL}/products?_page=${page}&_per_page=18`);
  const { data: shopData } = useFetch(`${process.env.NEXT_PUBLIC_JSON_SERVER_URL}/shops?_limit=10`);
